...
local param_names = {"sinsin_attack","sinsin_release","sinsin_phase","sinsin_index","sinsin_modnum","sinsin_modeno","sinsin_amp","sinsin_pan","tritri_attack","tritri_release","tritri_width","tritri_modwidth","tritri_phase","tritri_modphase","tritri_index","tritri_modnum","tritri_modeno","tritri_amp","tritri_pan","ringer_index","ringer_amp","ringer_pan","trisin_attack","trisin_release","trisin_phase","trisin_index","trisin_modnum","trisin_modeno","trisin_amp","trisin_pan","karplu_index","karplu_coef","karplu_amp","karplu_pan","resonz_index","resonz_amp","resonz_pan"}
